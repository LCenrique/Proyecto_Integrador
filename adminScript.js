...
if (!products || products.length === 0) {
  ...
  // BOTAS
  { id:21, nombre:"Bota Motociclista Negra",    cat:"botas",        precio:1850, precioOld:2200, oferta:true,  favorito:false, destacado:true,  emoji:"🥾", desc:"Cuero genuino con suela robusta.", descL:"Botas de cuero genuino con suela gruesa y resistente, diseñadas para ofrecer comodidad, estilo y gran durabilidad."},
  { id:22, nombre:"Bota Combat Militar",        cat:"botas",        precio:1650, precioOld:1990, oferta:true,  favorito:false, destacado:false, emoji:"🥾", desc:"Diseño militar con gran resistencia.", descL:"Botas de inspiración militar fabricadas con lona y cuero de alta calidad, ideales para un uso exigente y prolongado."},
  { id:23, nombre:"Bota Western Punta Fina",    cat:"botas",        precio:2400, precioOld:null, oferta:false, favorito:false, destacado:false, emoji:"🥾", desc:"Estilo western con bordado exclusivo.", descL:"Botas estilo western elaboradas en cuero con finos bordados decorativos que aportan un acabado exclusivo y elegante."},
  // PLAYERAS
  { id:24, nombre:"Playera Calavera Estampada", cat:"playeras",     precio:320,  precioOld:420,  oferta:true,  favorito:false, destacado:true,  emoji:"👕", desc:"Algodón suave con estampado llamativo.", descL:"Playera confeccionada en algodón 100% con un estampado de calavera de alta calidad que mantiene sus colores por más tiempo."},
  { id:25, nombre:"Playera Manga Larga Térmica",cat:"playeras",     precio:350,  precioOld:440,  oferta:true,  favorito:false, destacado:false, emoji:"👕", desc:"Comodidad y calidez para todo clima.", descL:"Playera térmica de manga larga confeccionada en algodón suave que brinda comodidad y protección durante los días frescos."},
  { id:26, nombre:"Playera Crop Metal Gráfico", cat:"playeras",     precio:260,  precioOld:340,  oferta:true,  favorito:false, destacado:false, emoji:"👕", desc:"Corte crop con diseño rockero.", descL:"Playera tipo crop con estampado inspirado en bandas de rock, ideal para crear un look moderno y auténtico."},
  { id:27, nombre:"Playera Raglán Bicolor",     cat:"playeras",     precio:290,  precioOld:null, oferta:false, favorito:false, destacado:false, emoji:"👕", desc:"Diseño bicolor de estilo casual.", descL:"Playera raglán con combinación de colores y mangas 3/4, perfecta para un estilo casual y cómodo durante todo el día."},
  // PIERCINGS
  { id:28, nombre:"Piercing Septum Plata",      cat:"piercings",    precio:180,  precioOld:240,  oferta:true,  favorito:false, destacado:true,  emoji:"💎", desc:"Acero quirúrgico seguro y duradero.", descL:"Piercing para septum fabricado en acero quirúrgico 316L, resistente a la corrosión y cómodo para el uso diario."},
  { id:29, nombre:"Piercing Helix Aro",         cat:"piercings",    precio:140,  precioOld:null, oferta:false, favorito:false,  destacado:true, emoji:"💎", desc:"Titanio ligero ideal para uso diario.", descL:"Aro para helix elaborado en titanio grado implante, ligero, seguro para la piel y perfecto para uso continuo."},
  { id:30, nombre:"Piercing Nariz Diamante",    cat:"piercings",    precio:220,  precioOld:280,  oferta:true,  favorito:false, destacado:false, emoji:"💎", desc:"Brillo elegante con cristal premium.", descL:"Piercing para nariz con cristal brillante y estructura de acero inoxidable que aporta un toque elegante y discreto."},
  { id:31, nombre:"Piercing Daith Corazón",     cat:"piercings",    precio:200,  precioOld:null, oferta:false, favorito:false, destacado:false, emoji:"💎", desc:"Diseño de corazón en plata 925.", descL:"Piercing daith con delicado diseño de corazón elaborado en plata 925, ideal para complementar cualquier estilo."},
  // ACCESORIOS
  { id:32, nombre:"Mochila Hello Kitty Alt",    cat:"accesorios",   precio:680,  precioOld:850,  oferta:false,  favorito:false, destacado:true,  emoji:"🎒", desc:"Estilo kawaii con toque alternativo", descL:"Mochila de edición alternativa con amplio espacio interior y un diseño kawaii que destaca por su originalidad."},
  { id:33, nombre:"Gafas Redondas Vintage",     cat:"accesorios",   precio:420,  precioOld:null, oferta:false, favorito:false,  destacado:true,  emoji:"🕶️", desc:"Protección UV400 con diseño retro.", descL:"Gafas de estilo vintage con protección UV400 y montura metálica resistente para un look clásico y moderno."},
  { id:34, nombre:"Sombrero Fedora Cuero",      cat:"accesorios",   precio:550,  precioOld:690,  oferta:true,  favorito:false, destacado:false, emoji:"🎩", desc:"Fedora de cuero con acabado premium.", descL:"Sombrero fedora elaborado en cuero con acabados premium y una banda decorativa que resalta su elegante diseño."},
  // HERRAMIENTAS
  { id:35, nombre:"Cuchillo Multiherramienta",  cat:"herramientas", precio:890,  precioOld:1100, oferta:true,  favorito:false, destacado:true,  emoji:"🔧", desc:"12 herramientas en un solo accesorio.", descL:"Multiherramienta fabricada en acero inoxidable con 12 funciones esenciales para actividades al aire libre y uso cotidiano."},
  { id:36, nombre:"Linterna Táctica LED",       cat:"herramientas", precio:340,  precioOld:null, oferta:false, favorito:false, destacado:false, emoji:"🔦", desc:"Iluminación potente con zoom ajustable.", descL:"Linterna LED de alta potencia con función de zoom ajustable, diseñada para ofrecer una iluminación intensa y confiable."},
  { id:37, nombre:"Navaja Plegable Negra",      cat:"herramientas", precio:560,  precioOld:700,  oferta:true,  favorito:false, destacado:false, emoji:"🔪", desc:"Hoja de acero D2 ultrarresistente.", descL:"Navaja plegable con hoja de acero D2 y mango G10 ergonómico, ideal por su resistencia y precisión de corte."},
  // ROPA
  { id:38, nombre:"Chaleco Piel Motociclista",  cat:"ropa",         precio:1800, precioOld:2200, oferta:false,  favorito:false, destacado:true,  emoji:"🧥", desc:"Chaleco de cuero para un look biker.", descL:"Chaleco confeccionado en cuero genuino con múltiples bolsillos y un diseño inspirado en el estilo biker clásico."  },
  { id:39, nombre:"Pantalón Cargo Oscuro",      cat:"ropa",         precio:620,  precioOld:null, oferta:false, favorito:false,  destacado:true,  emoji:"👖", desc:"Seis bolsillos y máxima comodidad.", descL:"Pantalón cargo elaborado con tela resistente y seis bolsillos funcionales que ofrecen comodidad y gran capacidad."},
  // CALZADO
  { id:40, nombre:"Tenis Chunky Blanco",        cat:"calzado",      precio:1100, precioOld:1380, oferta:true,  favorito:false, destacado:true,  emoji:":v", desc:"Estilo Y2K con suela de gran volumen.", descL:"Tenis de estilo Y2K con suela gruesa que proporciona comodidad, estabilidad y un diseño moderno en tendencia."  },
  { id:41, nombre:"Oxford Cuero Negro",         cat:"calzado",      precio:980,  precioOld:null, oferta:false, favorito:false, destacado:true,  emoji:"👞", desc:"Elegancia clásica en cuero genuino.", descL:"Zapatos Oxford elaborados en cuero negro con acabado elegante y suela resistente, ideales para cualquier ocasión."  },
  { id:42, nombre:"Sandalias Plataforma",       cat:"calzado",      precio:750,  precioOld:940,  oferta:true,  favorito:false, destacado:false, emoji:"👡", desc:"Plataforma cómoda con hebilla ajustable.", descL:"Sandalias con plataforma de 5 cm y hebilla ajustable que brindan comodidad, estabilidad y un estilo contemporáneo."  },
  // STICKERS
  { id:43, nombre:"Pack Stickers Skulls x20",   cat:"stickers",     precio:80,   precioOld:120,  oferta:true,  favorito:false, destacado:true,  emoji:"🎨", desc:"20 stickers de vinilo resistentes al agua.", descL:"Paquete con 20 stickers de vinilo impermeable de alta calidad, ideales para personalizar laptops, botellas o libretas."  },
  { id:44, nombre:"Sticker Holográfico Dragon", cat:"stickers",     precio:45,   precioOld:null, oferta:false, favorito:false, destacado:true,  emoji:"🎨", desc:"Acabado holográfico con efecto brillante.", descL:"Sticker holográfico con diseño de dragón y acabado brillante que cambia de color según el ángulo de la luz."  },
    ];
    guardarEnStorage();
}
